...
export default () => {
  ...
  return (
    <div className="flex items-center justify-between bg-white md:flex-shrink-0 md:w-56 md:justify-center">
      <InertiaLink href="/">
        <Logo  src="/dashboard_logo.jpg" className="text-white fill-current"/>
      </InertiaLink>
